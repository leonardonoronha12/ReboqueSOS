  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute inset-x-0 bottom-0 flex justify-center p-3 sm:p-4">
        <div className={cn("w-full max-w-lg rounded-2xl bg-white border border-brand-border/20 shadow-soft")}>
          ...
          {footer ? <div className="p-4 border-t border-brand-border/20">{footer}</div> : null}
        </div>
      </div>
    </div>
  );
